...
public class StatusConverter {
	...
	void createFragmentsWithUrl(List<TweetFragment> fragments,
			URLEntity[] entities) {
		...
		if (entities != null) {
			...
			for (URLEntity entity : entities) {
				...
				String href = "<a href='" + url + "' target='_blank' + title='"
						+ url + "'>";
	...
	void createFragmentsWithTag(List<TweetFragment> fragments,
			HashtagEntity[] tags) {
	...
	void createFragmentsWithMention(List<TweetFragment> fragments,
